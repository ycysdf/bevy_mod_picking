    ...
    fn build(&self, app: &mut App) {
        ...
        app.add_plugins(HighlightPlugin::<bevy_pbr::StandardMaterial> {
            highlighting_default: |mut assets| GlobalHighlight {
                hovered: assets.add(bevy_color::Color::rgb(0.35, 0.35, 0.35)),
                pressed: assets.add(bevy_color::Color::rgb(0.35, 0.75, 0.35)),
                #[cfg(feature = "selection")]
                selected: assets.add(bevy_color::Color::rgb(0.35, 0.35, 0.75)),
            },
        });
